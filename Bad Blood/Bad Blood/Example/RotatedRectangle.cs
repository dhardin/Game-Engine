...
namespace Game
{
    public class RotatedRectangle
    {
        ...
        {
            Vector2 tempOldPos = new Vector2(CollisionRectangle.X, CollisionRectangle.Y);


            CollisionRectangle.X += (int)(newPos.X - tempOldPos.X);
            CollisionRectangle.Y += (int)(newPos.Y - tempOldPos.Y);
        }
